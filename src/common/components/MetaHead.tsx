...
const MetaHead = (props: IMetaHead) => {
  ...
  return (
    <Head>
      ...
      <meta name="robots" content={typeof window !== 'undefined' && window.location.origin.includes(".world") ? "nofollow, noindex" : "follow, index"} />
      <meta charSet="UTF-8" />
      <meta
        name="viewport"
        content="width=device-width, initial-scale=1, shrink-to-fit=no"
      />
      <link rel="canonical" href={pagesSchema.slug === "home" ? process.env.NEXT_PUBLIC_BASE_URL : process.env.NEXT_PUBLIC_BASE_URL + pagesSchema.slug} />
      ...
      <meta
        property="og:url"
        content={pagesSchema.slug === "home" ? process.env.NEXT_PUBLIC_BASE_URL : process.env.NEXT_PUBLIC_BASE_URL + pagesSchema.slug}
      />
