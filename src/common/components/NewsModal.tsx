    ...
    <div className="fixed top-0 left-0 w-full h-full z-10 bg-black bg-opacity-50">
      <div className="mt-[40%] lg:mt-[20%] w-fit bg-white mx-auto p-2 rounded">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <Image src="/images/news/img_toggle.png" alt="image translate" width={150} height={150} className="rounded" />
        </div>
        <div className="text-black my-4 text-center">You can now scan and TRANSLATE IMAGE directly!</div>
        <Button
          type="button"
          title="ok"
