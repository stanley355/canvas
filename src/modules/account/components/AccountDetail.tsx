    ...
    <div>
      ...
      <div className='mb-8'>
        ...
        <div className='flex items-center gap-2'>
          <Image width={16} height={16} src={"/images/icon/google.svg"} alt='Google' />
      ...
      <div className='mb-6'>
        ...
        <Link className='flex items-center gap-2 py-2 border-b w-fit hover:border-b-black' href="/subscriptions">
            <FaRupiahSign />
      ...
      <div className='mb-8'>
        ...
        <Button onClick={handleLogout} variant={'secondary'} size={'sm'} className='hover:bg-black hover:text-white'>Logout</Button>
      </div>
    </div>
  )
}
