...
const AccountStudentForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { student_id, student_email, institution_level, institution_name, institution_name_other } = target;
    ...
    if (student_email.value && !student_email.value.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)) {
    ...
    if (file) {
      ...
      const storageRef = ref(storage, `student_card/${institution_level.value}/${student_id.value}`);
    ...
    const payload = {
      ...
      ...file && { studentCardImgUrl: `student_card/${institution_level.value}/${student_id.value}` },
      institutionLevel: institution_level.value,
      institutionName: institution_name.value ? institution_name.value : institution_name_other.value
    }
