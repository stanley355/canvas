...
import { TbCircleCheck, TbArrowBadgeLeft, TbEye, TbArrowBadgeRight } from "react-icons/tb"
  ...
  return (
    <div className="lg:container lg:mx-auto">
      ...
      <div className="px-4 pb-4 mt-16 lg:mt-4 lg:w-1/3">
        ...
        <div className="mb-4">Enjoy 50% discount pricing to LanguageAi, feedback your writing, and raise your grades!</div>
          <Link href="/premium/students/" className="flex items-center gap-1 p-2 mb-8 text-white rounded-md bg-emerald-800 hover:bg-emerald-700 w-fit">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/premium/students/" className="flex items-center p-2 text-white rounded-md bg-emerald-800 hover:bg-emerald-700 w-fit">
