  ...
  return (
    <div>
      ...
      <Select
        ...
        options={[
          {
            label: "UNIKA Atma Jaya Jakarta",
            value: "UNIKA Atma Jaya Jakarta",
          },
          {
            label: "Sekolah Sentosa Jakarta",
            value: "Sekolah Sentosa Jakarta",
          },
          {
      ...
      {showInput && (
        <div className="mb-8">
          <label htmlFor="institution_name_other">
            Please input your School / University Name{" "}
