...
const CheckbotResulTextareaDiffBtn = (props: CheckbotResulTextareaDiffBtnProps) => {
  ...
  return (
    <div className='rounded-lg flex'>
      ...
      onClick={()=> setActiveDiff(CheckbotDiff.Added)}
        className={cn('w-full rounded-none justify-center border-none hover:text-brand-primary',
