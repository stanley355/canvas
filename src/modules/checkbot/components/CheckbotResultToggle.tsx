...
const CheckbotResultToggle = (props: ICheckbotResultToggle) => {
  ...
  return (
    <div className='grid grid-cols-3 gap-2 mb-2'>
      <Button
        type='button'
        wrapperClassName={classNames('w-full border border-red-500 rounded p-1 h-fit', resultFormat === "removed" ? "bg-red-500 text-white" : "text-red-500")}
      ...
      <Button
        type='button'
        wrapperClassName={classNames('w-full border border-gray-700 rounded p-1 h-fit', !resultFormat ? "bg-black text-white" : "text-gray-700")}
        buttonClassName='w-full flex items-center justify-center gap-1'
      ...
      <Button
        type='button'
        wrapperClassName={classNames('w-full border border-green-500 rounded p-1 h-fit', resultFormat === "added" ? "bg-green-500 text-white" : "text-green-500")}
        buttonClassName='w-full flex items-center justify-center gap-1'
