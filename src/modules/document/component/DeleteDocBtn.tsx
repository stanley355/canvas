...
const DeleteDocBtn = (props: IDeleteDocBtn) => {
  ...
  return (
    <div>
      ...
      {showModal && (
        <div className="fixed top-0 left-0 bg-white bg-opacity-40 w-full h-full z-5">
          <div className="w-[400px] mt-40 mx-auto bg-white shadow shadow-black p-4 rounded text-xl">
            <div className="mb-4 text-black text-center font-semibold">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button
                ...
                disabled={isLoading}
                title="No"
                wrapperClassName="border border-gray-500 p-2 text-black font-semibold rounded"
                buttonClassName="w-full h-full"
