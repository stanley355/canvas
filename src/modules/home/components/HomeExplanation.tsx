  ...
  return (
    <div className="container mx-auto mt-8 lg:mt-16 lg:grid lg:grid-cols-2 lg:gap-16">
      <div className="mb-16 lg:flex lg:border-b">
        <div className="lg:w-1/3">
          ...
          <div className="mb-4 text-lg">
            Be perfectly professional, clear, and convincing in a few clicks,
            not a few hours.
          </div>
        </div>
        <Image
      ...
      <div className="mb-16 lg:flex lg:border-b ">
        <div>
          <div className="mb-4 text-4xl font-semibold">
            The right text for the context
          </div>
          <div className="mb-4 text-lg">
            Get personalized suggestions based on what you’re writing and who
            will read it.
          </div>
        </div>
        <Image
      ...
      <div className="mb-16 lg:flex lg:border-b">
        <div>
          ...
          <div className="mb-4 text-lg">
            LanguageAi understands both your personal style and your brand style
            guide to help you find your voice..
          </div>
        </div>
        <Image
