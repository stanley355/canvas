    ...
    <div className='p-4 border-y'>
      ...
      <div className='lg:grid lg:grid-cols-2'>
        <div className='mb-8'>
          ...
          />
          <div className='text-lg px-4 text-justify lg:hidden'>How LanguageAI improves business outcomes and where the industry is headed with technology & machine translation</div>
        </div>
        <div>
          <Image src="/images/forbes.png" alt='smartling'
            width={250}
            height={250}
            className='rounded mx-auto'
          />
          ...
          />
          <div className='text-lg text-justify px-4 lg:hidden'>Language AI is poised to transform vast swaths of society and the economy.</div>
        </div>
      </div>
    </div>
  )
