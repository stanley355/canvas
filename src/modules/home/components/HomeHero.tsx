  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-full lg:w-2/3 lg:mx-auto mt-12"
      >
        ...
        <Button
          type="submit"
          wrapperClassName="h-full text-white text-lg w-full bg-black p-1 mt-4 lg:w-1/2 lg:mx-auto border-white border"
      ...
      <div className="mt-8 lg:w-2/3 lg:mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link
            href="/languagegpt?prompt=Translate 'Apa kabar?' in German, English, and Japanese"
            className="bg-white text-black p-2 rounded"
          >
            Translate &quot;Apa kabar?&quot; in German, English, and Japanese
          </Link>
          <Link
            href="/languagegpt?prompt=What is the meaning of 'Als ik Netherlander was'?"
            className="bg-white text-black p-2 rounded"
          >
            What is the meaning of &quot;Als ik Netherlander was&quot;?
          </Link>
          <Link
            href="/languagegpt?prompt=Fix my spelling: There re ten thosand weys to go to Rome"
            className="bg-white text-black p-2 rounded"
          >
            Fix my spelling: There re ten thosand weys to go to Rome{" "}
          </Link>
          <Link
            href="/languagegpt?prompt=What is the hardest language in the world?"
            className="bg-white text-black p-2 rounded"
          >
