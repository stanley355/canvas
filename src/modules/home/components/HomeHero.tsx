...
const HomeHero = () => {
  ...
  return (
    <>
      <div style={{backgroundColor: "rgba(255, 255, 255 , 0.5)" }} className="bg-[url('/images/home/hero-background.webp')] bg-cover py-4 mb-4 lg:bg-blend-overlay">
        <Image
      ...
      <div className='px-4'>
        <h1 className='mb-4 text-4xl font-bold text-center lg:text-5xl'>Solve your language problems</h1>
