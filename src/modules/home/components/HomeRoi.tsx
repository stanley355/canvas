  ...
  return (
    <div className="py-8 bg-emerald-700">
      <div className="container mx-auto text-white lg:mb-8">
        ...
        <div className="mb-4 text-3xl font-semibold text-center">What's the ROI on Better Writing?</div>
        <div className="mb-4 text-center lg:w-1/3 lg:mx-auto">17x. Organizations that use LanguageAi save an average of Rp125,000,000 per employee per year. Data stays private, productivity rises, inbox numbers drop, and teams can focus on what they should do, not on how they should say it.</div>
      </div>
