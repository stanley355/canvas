...
const ImageToTextResult = (props: IImageToTextResult) => {
  ...
  return (
    <div
      className={cn(
        "pb-2 border-b h-60 lg:border lg:rounded-md",
        recognizedText ? "block" : "hidden lg:block"
      )}
    >
      <div className="p-2 mb-2 overflow-y-scroll text-sm h-4/5">
        {recognizedText ? recognizedText : "Upload image to convert"}
      </div>
      <Button
        className="float-right gap-1 mr-2"
