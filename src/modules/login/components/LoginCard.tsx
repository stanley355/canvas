...
const LoginCard = () => {
  return (
    <div className="p-4 py-6 border border-brand-primary rounded-lg lg:w-[400px] mt-[5%] mx-auto text-brand-primary">
      ...
      <h1 className="mb-6 text-2xl font-semibold text-center ">Login in one click</h1>
