...
const LoginForm = () => {
  ...
  return (
    <div className="border border-white bg-gray-600 rounded-md p-4 lg:w-1/3 mt-20 mx-auto">
      ...
      <h3 className="text-center text-lg font-semibold mb-2">Sign Up / Login with One Click</h3>
      <GoogleLoginBtn />

      <div className="text-center mt-2">*Email & Password Login Coming Soon</div>
    </div>
  );
};
