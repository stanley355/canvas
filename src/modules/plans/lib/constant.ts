export const PLANS_OPTIONS = [
  {
    title: "Pay-as-you-Go",
    desc: "Only pay for what you need, no expiration time",
    price: "Rp1",
    unit: "per word",
    url: "/plans/topup/",
  },
...
export const TRANS_QUALITY_COMPARISON = [
  {
    oriText:
    ...
    nonPremium:
      "Naruto (ナルト) is a manga series by Masashi Kishimoto which was adapted into an anime series. The Naruto manga tells the story of the life of the main character, Naruto Uzumaki, a hyperactive, cheerful and ambitious ninja who wants to fulfill his wish of getting the title of Hokage, leader and strongest ninja in his village. The series is based on a one-shot comic by Kishimoto published in the August 1997 issue of Akamaru Jump.",
    premium:
      "Naruto (ナルト) is a manga series by Masashi Kishimoto that was adapted into an anime series. Naruto manga revolves around the life of its main character, Naruto Uzumaki, a hyperactive, jovial, and ambitious ninja who wishes to realize his desire to earn the Hokage title, the leader and strongest ninja in his village. This series is based on a one-shot comic by Kishimoto published in the Akamaru Jump edition in August 1997.",
  },

  {
    ...
    nonPremium:
      "Artificial intelligence (AI) is a field of computer science devoted to solving cognitive problems commonly associated with human intelligence, such as learning, problem solving, and pattern recognition. Artificial Intelligence, often abbreviated as 'AI', may connote robotics or a futuristic scene, Artificial Intelligence (AI) moves beyond science fiction robots, into modern advanced computer science non-fiction. Professor Pedro Domingos, a leading researcher in this field, describes the 'five tribes' of machine learning, consisting of symbolic, derived from logic and philosophy; connectionist, originating from neuroscience; evolutionary, relating to evolutionary biology; Bayesian, related to statistics and probability; and analogical originating from psychology. More recently, advances in the efficiency of statistical computing have seen Bayesians successfully advance the field in a number of areas, called 'machine learning'. Likewise, advances in network computing have led connectionists to expand into a subfield called 'deep learning'. Machine learning (ML) and deep learning (DL) are fields of computer science that originate from the discipline of Artificial Intelligence.",
    premium:
