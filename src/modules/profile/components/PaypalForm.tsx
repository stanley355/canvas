  ...
  return (
    <div className="mt-8">
      <div className="font-semibold text-center mb-2 text-xl">
        {type === "paypal" ? "Paypal Topup" : "Card Topup"}
      </div>
      <div className="mb-2 text-lg">How much would you like to topup?</div>
      <div className="my-2">* 1 USD will be converted to Rp 14.000</div>
      <div className="my-2">* 1 SGD will be converted to Rp 11.000</div>
          ...
          <Button
            ...
            title={
              amount >= 1
                ...
                : "Minimum topup amount is $1.00"
            }
            wrapperClassName="w-full bg-gray-500 p-2 text-white font-semibold rounded text-center"
          />
        )}
      </form>
