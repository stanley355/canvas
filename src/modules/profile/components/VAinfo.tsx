...
const VAinfo = ({ info }: IVAInfo) => (
  <div className='mt-4 text-lg'>
    <div>Payment via: <i>{info.bank_name}</i> </div>
    <div className='mt-2'>Amount:  <i>Rp{info.amount}</i> </div>
    <div className='text-center lg:flex lg:flex-row lg:items-center lg:justify-center my-2'>

    <div>Virtual Account Number: </div>
    <div className='lg:ml-2 italic underline text-blue-300'>{info.virtual_account_number}</div>
    </div>
