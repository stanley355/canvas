  ...
  return (
    <div className="container px-4 pb-8 mx-auto mt-20 text-white lg:grid lg:grid-cols-4 lg:mt-4 lg:gap-4">
      <div className="mb-8">
        ...
        />
        <div>
          Submit flawless writing with built-in proofreading that catches
      ...
      <div className="mb-8">
        ...
        />
        <div>
          Develop your best ideas and fine-tune your delivery faster with
          generative AI.
        </div>
      </div>
      <div className="mb-8">
        ...
        />
        <div>
          Ensure that your work is uniquely yours with plagiarism detection and
          citation support, including for AI use.
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        />
        <div>
          Stay focused with a seamless writing partner that works in all the
          work you will do in class and career.
        </div>
      </div>
    </div>
  );
