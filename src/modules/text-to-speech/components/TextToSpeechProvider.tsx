...
const TextToSpeechProvider = (props: TextToSpeechProviderProps) => {
  const [textToSpeechStates, textToSpeechDispatch] = useReducer(textToSpeechReducer, TEXT_TO_SPEECH_STATES);

  return (
    <TextToSpeechContext.Provider value={{ textToSpeechStates, textToSpeechDispatch }}>
      {props.children}
