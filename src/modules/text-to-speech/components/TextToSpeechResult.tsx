...
const TextToSpeechResult = (props: ITextToSpeechResult) => {
  ...
  return (
    <div className="px-2 mt-4 lg:mt-0">
      ...
      {fileName ? <div className="float-right mt-2 text-sm text-gray-500">*audio will show after convert</div> : <div className="flex items-center float-right mt-2 text-sm text-gray-500">*click the <TbDotsVertical /> icon to download </div>}
    </div>
  )
}
