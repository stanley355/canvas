  ...
  return (
    <>
      <form action="" className="border-x">
        <Button type="button" className="w-full h-40 gap-2 text-base rounded-none" variant="ghost">
          <TbMicrophone />
        ...
        <div className="flex items-center gap-2 p-2 lg:w-1/4 lg:ml-auto">
          <Select
            ...
            onChange={() => sendFirebaseEvent(FIREBASE_EVENT_NAMES.change.change_translate_audio_diff)}
          />

          <Button type="submit" className="flex-1">Translate</Button>
        </div>
      </form>
