...
import { TRANSLATE_COMPARISON } from "../lib/constant";

const TranslateComparison = () => {
  return (
    <div className="my-8 mb-16">
      <div className="font-semibold text-lg mb-2">
        Wanna Have Better Translation Result? Support us with{" "}
        <Link href="/premium/translate" className="underline text-blue-200">
          Premium Translation
        </Link>
        :{" "}
      </div>
