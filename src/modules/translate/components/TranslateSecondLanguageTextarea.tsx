...
const TranslateSecondLanguageTextarea = (props: TranslateSecondLanguageTextareaProps) => {
  ...
  return (
    <div className='relative mb-4'>
      ...
      />
      <NextButton className='absolute bottom-4 right-2 lg:right-3 p-2' onClick={() => copyToClipboard(secondLanguageText)}>
        <TbCopy />
        <span>Copy</span>
      </NextButton>
    </div>
