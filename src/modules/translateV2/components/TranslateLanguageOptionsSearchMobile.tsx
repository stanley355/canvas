...
const TranslateLanguageOptionsSearchMobile = (props: ITranslateLanguageOptionsSearchMobile) => {
  ...
  return (
    <div className='grid grid-cols-[15%_70%_15%] border'>
      ...
      {showSearch ?
        <Input placeholder='Search Language' autoFocus className='border-none focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0' />
