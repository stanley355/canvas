  ...
  return (
    <Layout>
      ...
      <div className="lg:container mx-auto px-2 lg:px-0">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 mb-8" id="checkbot_form">
          <CheckBotForm updateState={updateState} />
            <div>
              ...
              {resultFormat === "removed" &&  <div className="border border-gray-500 h-80 rounded-md p-2 overflow-y-scroll bg-white">{checkbotRemoved}</div> }
              {resultFormat === "added" &&  <div className="border border-gray-500 h-80 rounded-md p-2 overflow-y-scroll bg-white">{checkbotAdded}</div> }
              {resultFormat && <div className="text-white">*Go to No Diff to copy</div> }
            </div>
        </div>
        <CheckbotComparison />
        <FeedbackBox />
