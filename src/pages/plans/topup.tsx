    ...
    <Layout>
      ...
      <div className="bg-gradient-to-br from-white via-blue-300 to-white">
        <div className='w-full lg:w-[450px] mx-auto min-h-screen bg-white text-black p-4'>
          <h1 className='mt-4 mb-2 text-center text-3xl font-semibold'>Pay-as-you-Go</h1>
          <h2 className='text-center mb-2'>Only pay for what you need, no expiration time</h2>
          <div className='border border-gray-500 p-2 rounded'>
            Current Balance: <span className='text-green-700 font-semibold'>{user?.balance}</span>
          </div>
